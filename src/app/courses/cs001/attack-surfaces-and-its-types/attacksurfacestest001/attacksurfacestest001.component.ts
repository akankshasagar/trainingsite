...
@Component({
  selector: 'app-attacksurfacestest001',
  templateUrl: './attacksurfacestest001.component.html',
  styleUrls: ['./attacksurfacestest001.component.css']
})
export class Attacksurfacestest001Component {
  ...
  submitForm() { //working
    ...
    this.auth.attacksurfacesTestForm(this.model).subscribe({
      next: (response) => {
