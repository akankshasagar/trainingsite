...
@Component({
  selector: 'app-data-protection-test001',
  templateUrl: './data-protection-test001.component.html',
  styleUrls: ['./data-protection-test001.component.css']
})
export class DataProtectionTest001Component {
  ...
  submitForm() { //working
    ...
    this.auth.dataprotectForm(this.model).subscribe({
      next: (response) => {
